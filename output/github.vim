...
let s:gb.dark0 = ['#FAFBFC', 234]
let s:gb.dark1 = ['#E2E4E5', 237]
let s:gb.dark2 = ['#CACCCF', 239]
let s:gb.dark3 = ['#B3B6B8', 241]
let s:gb.dark4 = ['#9DA0A3', 243]

let s:gb.gray = ['#878A8E', 245]

let s:gb.light0 = ['#24292E', 229]
let s:gb.light1 = ['#363B40', 223]
let s:gb.light2 = ['#494E52', 250]
let s:gb.light3 = ['#5D6165', 248]
let s:gb.light4 = ['#727579', 246]

let s:gb.bright_red    = ['#D73A49', 167]
let s:gb.bright_green  = ['#22863A', 142]
let s:gb.bright_yellow = ['#F18338', 214]
let s:gb.bright_blue   = ['#005CC5', 109]
let s:gb.bright_purple = ['#6F42C1', 175]
let s:gb.bright_aqua   = ['#669CC2', 108]
let s:gb.bright_orange = ['#E36209', 208]
