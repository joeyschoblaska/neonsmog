...
let s:gb.dark0 = ['#1F232A', 234]
let s:gb.dark1 = ['#2E353B', 237]
let s:gb.dark2 = ['#3E474C', 239]
let s:gb.dark3 = ['#515B5D', 241]
let s:gb.dark4 = ['#646E6F', 243]

let s:gb.gray = ['#798381', 245]

let s:gb.light0 = ['#EFEEEA', 229]
let s:gb.light1 = ['#D7D8D3', 223]
let s:gb.light2 = ['#BFC2BD', 250]
let s:gb.light3 = ['#A7ACA8', 248]
let s:gb.light4 = ['#909794', 246]

let s:gb.bright_red    = ['#FB7DA7', 167]
let s:gb.bright_green  = ['#2CDA9D', 142]
let s:gb.bright_yellow = ['#FFCE5B', 214]
let s:gb.bright_blue   = ['#50A2D8', 109]
let s:gb.bright_purple = ['#A18BD3', 175]
let s:gb.bright_aqua   = ['#50C6D8', 108]
let s:gb.bright_orange = ['#FF965B', 208]
