...
let s:gb.dark0 = ['#0E0817', 234]
let s:gb.dark1 = ['#211D2C', 237]
let s:gb.dark2 = ['#34303E', 239]
let s:gb.dark3 = ['#484352', 241]
let s:gb.dark4 = ['#5D5867', 243]

let s:gb.gray = ['#736E7D', 245]

let s:gb.light0 = ['#EBE5F2', 229]
let s:gb.light1 = ['#D2CCD9', 223]
let s:gb.light2 = ['#B9B3C1', 250]
let s:gb.light3 = ['#A19CAA', 248]
let s:gb.light4 = ['#8A8493', 246]

let s:gb.bright_red    = ['#FF4365', 167]
let s:gb.bright_green  = ['#6EEB7A', 142]
let s:gb.bright_yellow = ['#F9C80E', 214]
let s:gb.bright_blue   = ['#1E9AFF', 109]
let s:gb.bright_purple = ['#F706CF', 175]
let s:gb.bright_aqua   = ['#2DE2E6', 108]
let s:gb.bright_orange = ['#FF6C11', 208]
