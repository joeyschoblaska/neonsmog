...
let s:gb.dark0 = ['#011627', 234]
let s:gb.dark1 = ['#192C3D', 237]
let s:gb.dark2 = ['#304253', 239]
let s:gb.dark3 = ['#485968', 241]
let s:gb.dark4 = ['#606F7E', 243]

let s:gb.gray = ['#778594', 245]

let s:gb.light0 = ['#E5EAF2', 229]
let s:gb.light1 = ['#D6DEEB', 223]
let s:gb.light2 = ['#BEC8D5', 250]
let s:gb.light3 = ['#A7B2BF', 248]
let s:gb.light4 = ['#8F9BAA', 246]

let s:gb.bright_red    = ['#FF5874', 167]
let s:gb.bright_green  = ['#ADDB67', 142]
let s:gb.bright_yellow = ['#ECC48D', 214]
let s:gb.bright_blue   = ['#82AAFF', 109]
let s:gb.bright_purple = ['#C792EA', 175]
let s:gb.bright_aqua   = ['#7FDBCA', 108]
let s:gb.bright_orange = ['#F78C6C', 208]
