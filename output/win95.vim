...
let s:gb.dark0 = ['#191716', 234]
let s:gb.dark1 = ['#2B2826', 237]
let s:gb.dark2 = ['#3D3A38', 239]
let s:gb.dark3 = ['#514C4A', 241]
let s:gb.dark4 = ['#66605E', 243]

let s:gb.gray = ['#7B7471', 245]

let s:gb.light0 = ['#EFE3DE', 229]
let s:gb.light1 = ['#D7CCC7', 223]
let s:gb.light2 = ['#BFB5B1', 250]
let s:gb.light3 = ['#A89F9B', 248]
let s:gb.light4 = ['#918986', 246]

let s:gb.bright_red    = ['#D61620', 167]
let s:gb.bright_green  = ['#64D764', 142]
let s:gb.bright_yellow = ['#C9E432', 214]
let s:gb.bright_blue   = ['#41B0ED', 109]
let s:gb.bright_purple = ['#DC3E8D', 175]
let s:gb.bright_aqua   = ['#4DE9D6', 108]
let s:gb.bright_orange = ['#F19C4A', 208]
