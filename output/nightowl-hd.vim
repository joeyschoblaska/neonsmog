...
let s:gb.bright_yellow = ['#F2D36D', 214]
let s:gb.bright_blue   = ['#78A3FF', 109]
let s:gb.bright_purple = ['#C584F0', 175]
let s:gb.bright_aqua   = ['#7BE3D0', 108]
let s:gb.bright_orange = ['#F78457', 208]
