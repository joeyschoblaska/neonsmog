...
let s:gb.dark0 = ['#101317', 234]
let s:gb.dark1 = ['#1A1D21', 237]
let s:gb.dark2 = ['#23262A', 239]
let s:gb.dark3 = ['#2B2E32', 241]
let s:gb.dark4 = ['#323539', 243]

let s:gb.gray = ['#57595C', 245]

let s:gb.light0 = ['#D4D4D5', 229]
let s:gb.light1 = ['#CBCBCC', 223]
let s:gb.light2 = ['#BFB5B1', 250]
let s:gb.light3 = ['#A0A1A3', 248]
let s:gb.light4 = ['#7C7D80', 246]

let s:gb.bright_red    = ['#E87979', 167]
let s:gb.bright_green  = ['#37D99E', 142]
let s:gb.bright_yellow = ['#FFE59E', 214]
let s:gb.bright_blue   = ['#5FB0FC', 109]
let s:gb.bright_purple = ['#C397D8', 175]
let s:gb.bright_aqua   = ['#50CAD2', 108]
let s:gb.bright_orange = ['#F0A988', 208]
